...
git checkout master && git checkout -b hotfix/1-little-bug
...
git checkout master && git checkout -b hotfix/2-minor-problem
...
git checkout master && git checkout -b hotfix/3-catastrophic-shai-hulud
...
git checkout hotfix/1-little-bug && git push --set-upstream origin hotfix/1-little-bug -f
git checkout hotfix/2-minor-problem && git push --set-upstream origin hotfix/2-minor-problem -f
git checkout hotfix/3-catastrophic-shai-hulud && git push --set-upstream origin hotfix/3-catastrophic-shai-hulud -f

git checkout master
git push --set-upstream origin master -f
git branch -D hotfix/1-little-bug hotfix/2-minor-problem hotfix/3-catastrophic-shai-hulud
...
git checkout develop && git checkout -b feature/1-refactoring
...
git checkout develop && git checkout -b feature/2-important-improvement
...
git checkout feature/1-refactoring && git push --set-upstream origin feature/1-refactoring -f
git checkout feature/2-important-improvement && git push --set-upstream origin feature/2-important-improvement -f
...
git branch -D feature/1-refactoring feature/2-important-improvement feature/3-supercool-new-feature
